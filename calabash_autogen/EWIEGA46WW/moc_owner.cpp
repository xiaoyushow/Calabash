...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Owner_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Owner_t qt_meta_stringdata_Owner = {
    {
QT_MOC_LITERAL(0, 5), // "Owner"
QT_MOC_LITERAL(6, 11), // "ownerSignal"
QT_MOC_LITERAL(18, 0) // ""

    },
    "Owner\0ownerSignal\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Owner[] = {
...
void Owner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Owner::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Owner::ownerSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Owner::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Owner.offsetsAndSize,
    qt_meta_data_Owner,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Owner_t
, QtPrivate::TypeAndForceComplete<Owner, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
