...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Http_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Http_t qt_meta_stringdata_Http = {
    {
QT_MOC_LITERAL(0, 4) // "Http"
...
const QMetaObject Http::staticMetaObject = { {
    ...
    qt_meta_stringdata_Http.offsetsAndSize,
    qt_meta_data_Http,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Http_t
, QtPrivate::TypeAndForceComplete<Http, std::true_type>
