...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Introduce_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Introduce_t qt_meta_stringdata_Introduce = {
    {
QT_MOC_LITERAL(0, 9) // "Introduce"
...
const QMetaObject Introduce::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Introduce.offsetsAndSize,
    qt_meta_data_Introduce,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Introduce_t
, QtPrivate::TypeAndForceComplete<Introduce, std::true_type>
